...
public class NativeZlib implements BungeeZlib
{
    ...
    {
        process( in, out, false ); // AntiBot
    }

    @Override
    public void process(ByteBuf in, ByteBuf out, boolean preallocatedBuffer) throws DataFormatException // AntiBot
    {
        // Smoke tests
        in.memoryAddress();
        out.memoryAddress();
