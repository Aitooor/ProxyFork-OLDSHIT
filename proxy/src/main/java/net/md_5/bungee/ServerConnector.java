...
public class ServerConnector extends PacketHandler
{
    ...
    public void handle(Login login) throws Exception
    {
        ...
        if ( user.isNeedLogin() || !( login.getDimension() instanceof Integer ) ) //AntiBot
        {
            ...
            if ( !user.isNeedLogin() ) //AntiBot //if false, means user came from captcha or server switch
            {
                if ( user.getServer() != null ) //AntiBot
                {
                    user.getServer().setObsolete( true ); //AntiBot
                ...
                if ( user.getServer() != null ) //AntiBot
                {
                    user.getServer().disconnect( "Quitting" ); //AntiBot
                }
            } else if ( user.isNeedLogin() ) //AntiBot
            {
                user.setNeedLogin( false ); //AntiBot
        ...
        } else
        {
            ...
            if ( this.user.getServer() != null ) //AntiBot
            {
                this.user.getServer().disconnect( "Quitting" ); //AntiBot
            }
        }
