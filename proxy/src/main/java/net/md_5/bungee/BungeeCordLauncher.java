...
public class BungeeCordLauncher
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        System.setProperty( "java.awt.headless", "true" ); //AntiBot
        ...
        bungee.getLogger().log( Level.INFO, "Encendido BungeCord AntiBot {0}", bungee.getGameVersion() ); //AntiBot
        bungee.start();
        ...
        if ( !options.has( "noconsole" ) )
        {
            ...
            while ( bungee.isRunning && ( line = bungee.getConsoleReader().readLine( ">" ) ) != null )
            {
                ...
                {
                    bungee.getConsole().sendMessage( new ComponentBuilder( "Doesn't exist!" ).color( ChatColor.RED ).create() ); //AntiBot
                }
            }
        }
    }
