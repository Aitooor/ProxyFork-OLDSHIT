...
public class HandlerBoss extends ChannelInboundHandlerAdapter
{
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception
    {
        if ( handler != null )
        {
            ...
            {
                ProxyServer.getInstance().getLogger().log( Level.INFO, "{0} has connected", handler.toString() ); // AntiBot, use toString() instead of object
            }
        }
    }
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception
    {
        if ( handler != null )
        {
            ...
            if ( !( handler instanceof InitialHandler || handler instanceof PingHandler ) )
            {
                ProxyServer.getInstance().getLogger().log( Level.INFO, "{0} has disconnected", handler.toString() ); // AntiBot, use toString() instead of object
            }
        }
    }
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception
    {
        ...
        if ( handler != null )
        {
            ...
            try
            {
                if ( !channel.isClosed() ) //AntiBot Do not handle packets if closed
                {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception
    {
        if ( ctx.channel().isActive() )
        {
            ...
            if ( logExceptions )
            {
                ...
                {
                    ProxyServer.getInstance().getLogger().log( Level.WARNING, "{0} - read timed out", handler.toString() ); // AntiBot, use toString() instead of object
                } else if ( cause instanceof DecoderException )
                {
                    if ( cause instanceof CorruptedFrameException )
                    {
                        ...
                        {
                            handler.toString(), cause.getMessage() // AntiBot, use toString() instead of object
                        } );
                    } else if ( cause.getCause() instanceof BadPacketException )
                    {
                        ...
                        {
                            handler.toString(), cause.getCause().getMessage() // AntiBot, use toString() instead of object
                        } );
                ...
                } else if ( cause instanceof IOException || ( cause instanceof IllegalStateException && handler instanceof InitialHandler ) )
                {
                    ...
                    {
                        handler.toString(), cause.getClass().getSimpleName(), cause.getMessage() // AntiBot, use toString() instead of object
                    } );
                } else if ( cause instanceof QuietException )
                {
                    ...
                    {
                        handler.toString(), cause // AntiBot, use toString() instead of object
                    } );
                } else
                {
                    ProxyServer.getInstance().getLogger().log( Level.SEVERE, handler.toString() + " - encountered exception", cause );  // AntiBot, use toString() instead of object
                }
            }
