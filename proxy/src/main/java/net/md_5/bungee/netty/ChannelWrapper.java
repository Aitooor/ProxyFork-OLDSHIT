...
public class ChannelWrapper
{
    ...
    public void write(Object packet) // AntiBot - old plugins may use that, so we keep PacketWrapper check
    {
        if ( !closed )
        {
    ...
    public void setCompressionThreshold(int compressionThreshold)
    {
        ...
        {
            PacketDecompressor packetDecompressor = new PacketDecompressor(); //AntiBot
            packetDecompressor.setThreshold( compressionThreshold ); //AntiBot
