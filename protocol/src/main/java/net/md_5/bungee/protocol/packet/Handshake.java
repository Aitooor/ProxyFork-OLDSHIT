...
public class Handshake extends DefinedPacket
{
    ...
    // AntiBot - see https://github.com/PaperMC/Waterfall/blob/master/BungeeCord-Patches/0060-Additional-DoS-mitigations.patch
    ...
    {
        DefinedPacket.doLengthSanityChecks( buf, this, Direction.TO_SERVER, -1, EXPECTED_MIN_LENGTH, EXPECTED_MAX_LENGTH ); // AntiBot
