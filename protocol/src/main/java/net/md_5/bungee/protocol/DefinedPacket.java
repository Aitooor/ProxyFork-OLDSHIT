...
import online.nasgar.antibot.utils.FastBadPacketException;
import online.nasgar.antibot.utils.FastException;
import online.nasgar.antibot.utils.FastOverflowPacketException;
...
public abstract class DefinedPacket
{
    ...
    private static final FastException VARINT_TOO_BIG = new FastException( "varint too big" ); // AntiBot
    private static final FastException ILLEGAL_BUF = new FastException( "Buffer is no longer readable" ); // AntiBot
    ...
    public static int readVarInt(ByteBuf input, int maxBytes)
    {
        ...
        int bytes = 0;
        byte in;
        // int readable = input.readableBytes(); // AntiBot
        while ( true )
        {
            // AntiBot start
            // if ( readable-- == 0 )
    ...
    // AntiBot start - see https://github.com/PaperMC/Waterfall/blob/master/BungeeCord-Patches/0060-Additional-DoS-mitigations.patch
