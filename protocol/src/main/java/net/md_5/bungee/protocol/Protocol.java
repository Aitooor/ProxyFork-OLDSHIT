...
import online.nasgar.antibot.packets.Player;
import online.nasgar.antibot.packets.PlayerAbilities;
import online.nasgar.antibot.packets.PlayerPosition;
...
import online.nasgar.antibot.packets.TeleportConfirm;
...
public enum Protocol
{
    ...
    AntiBot
    {

        {
            ...
            TO_SERVER.registerPacket(
                    ...
                    map( ProtocolConstants.MINECRAFT_1_17, 0x14 )
            );
            TO_SERVER.registerPacket(
    ...
    /*========================================================================*/
    public final DirectionData TO_SERVER = new DirectionData( this, ProtocolConstants.Direction.TO_SERVER ); // AntiBot -> public
    public final DirectionData TO_CLIENT = new DirectionData( this, ProtocolConstants.Direction.TO_CLIENT ); // AntiBot -> public
    ...
    public static final class DirectionData // AntiBot -> public
    {
        ...
        private void registerPacket(Class<? extends DefinedPacket> packetClass, ProtocolMapping... mappings) // AntiBot
        {
